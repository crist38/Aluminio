# 🪟 Prowindows Limitada — Sistema de Pautas de Corte

Sistema web interno para el cálculo automático de **pautas de corte de aluminio**, generación de cotizaciones y gestión de precios de perfiles y accesorios.

---

## 📋 Descripción

Aplicación web de uso interno desarrollada para **Prowindows Limitada** (Coquimbo, Chile). Permite calcular con precisión los cortes de perfiles de aluminio para:
...
| 📐 **Vista Previa** | Canvas esquemático del producto con dimensiones en tiempo real |
...
- **Canvas API**: Vista previa esquemática de productos
...
│   ├── logo.png            # Logo Prowindows
│   ├── css/
│   │   └── styles.css      # Estilos premium dark mode
│   └── js/
...
**Prowindows Limitada**  
Av. Gerónimo Méndez 2115, Galpón 17, Barrio Industrial — Coquimbo, Chile
